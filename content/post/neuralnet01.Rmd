...
Algunas preguntas que el lector debe tener en este momento son:

- ¿de dónde vienen los valores anteriores?
- ¿cómo puedo obtener esos valores de la red gráfica?

Para responder las preguntas vamos a tomar como ejemplo el primer valor de la Edad escalada, es decir el valor `r test[1, 1]`, y con ella vamos a estimar el valor de resistencia escalada. Vamos introducir este valor en la red número uno y vamos a realizar las operaciones indicadas en la figura asociadas a `mod1`.
